...
(function () {
  ...
  var SNIPPETS = [
    ...
    },
    {
      ...
      target: 'Shape rectangle Size (e.g. "Contents>Rectangle 1>Rectangle Path 1>Size")',
      expression: 'var t = thisComp.layer("TEXT");\nvar r = t.sourceRectAtTime(time, false);\nvar pad = 20;\n[r.width + pad * 2, r.height + pad * 2]',
      notes: 'Replace TEXT with the text layer name. Also link the box position: thisComp.layer("TEXT").transform.position (offset by [r.left + r.width/2, r.top + r.height/2] for exact centering).',
      requires: []
    },
    {
      id: 'grid-by-index',
