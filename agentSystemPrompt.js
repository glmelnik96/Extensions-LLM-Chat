...
(function () {
  ...
  var AGENT_SYSTEM_PROMPT = [
    ...
    '## Masks',
    '',
    '- `add_mask` — creates a mask on a layer. Default: layer-sized rectangle.',
    ...
    '- **Mask property paths**: Use `Masks>Mask 1>Mask Expansion`, `Masks>Mask 1>Mask Feather`, `Masks>Mask 1>Mask Opacity` for keyframing mask properties. The word "Mask" before the property name is required.',
