...
> **Legacy (multi-pass expression pipeline).** Текущая панель — **AE Motion Agent**: публикация результатов описана в **[legacy-chat-publication-final-only-policy.md](legacy-chat-publication-final-only-policy.md)** (раздел *Current agent*) и **[../../final-architecture.md](../../final-architecture.md)**. Ниже — правила исторического pipeline.
...
See **[legacy-pipeline-runtime-flow-stages-and-models.md](legacy-pipeline-runtime-flow-stages-and-models.md)** for the stage sequence and model roles.
