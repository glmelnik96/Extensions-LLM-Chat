...
- **check-required-files.js**: Prompt-library system prompts, knowledge-base index and README, config example, and key active docs (configuration, secret-handling, final-architecture, capabilities-and-roadmap).
