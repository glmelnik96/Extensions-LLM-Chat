...
- **check-required-files.js**: Prompt-library system prompts, knowledge-base index and README, config example, and key docs (configuration, secret-handling, **manual-apply-policy**, **final-result-policy** — may be short redirects to the legacy archive).
